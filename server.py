...
cities = {
    'москва': ['1652229/6500255ac1eb9231949d', '1030494/585fa9216b5e794e7b9e'],
    'нью-йорк': ['1533899/9562b453c696019ccb1f', '937455/43758ad67de90538eeac'],
    'париж': ["1652229/1c46d1babf7b2955b45f", '997614/8353baea3ce9be276a55']
}
...
def handle_dialog(res, req):
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        elif req['request']["command"].lower() == 'помощь' or req['request']["original_utterance"].lower() == 'помощь':
            res['response']['text'] = 'Сработал вызов помощи'
        else:
            play_game(res, req)
